...
<div class="container my-4 py-4">
    ...
    <div class="row">
      ...
      <div class="col-md-4">
        <div class="card">
          <img src="{{ asset('storage/images/'.$noticia->urlImg) }}" class="card-img-top" alt="{{ $noticia->name }}">
          <div class="card-body">
            <h5 class="card-title">{{ $noticia->id }}</h5>
            <p class="card-text">{{ $noticia->body }}</p>
            <a href="{{ route('noticia.detalle', $noticia->id) }}" class="btn btn-outline-success mb-4">Ver más</a>
          </div>
        </div>
      </div>
      @endforeach
